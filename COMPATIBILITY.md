...
This file is the published compatibility contract for **BDVM.Management 1.1.0**. It describes the current incremental release; it is not a promise that BDVM is feature-complete.
...
This release is selected by these dependency-closed profiles: **economic, complete**. The canonical machine-readable profiles live in the BDVM integration workspace and are validated before packaging. The minimal profile contains no Multiplayer or MultiplayerAPI dependency.
